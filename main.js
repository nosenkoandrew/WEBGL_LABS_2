...
function draw() {
  ...
  let t = rotateVector()
  gl.uniform3fv(shProgram.iUP, [t[0], t[1], t[2]]);
  sphere.DrawSphere();
  gl.uniform2fv(shProgram.iUserPoint, [-1, -1]);
  if (panner) {
    panner.setPosition(t[0], t[1], t[2])
  }
}
...
let context;
let radioButton = document.getElementById('filter');
let audio = null,
  source,
  biquadFilter,
  panner;
